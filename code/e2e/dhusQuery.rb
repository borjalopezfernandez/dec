...
def main
   ...
   url = "https://scihub.copernicus.eu/dhus/odata/v1/Products?$oplatformname:Sentinel-2"

   url = "https://scihub.copernicus.eu/dhus/search?q=%20platformname:Sentinel-2&rows=50&start=0"


   cmd = "curl -u #{dhusUser}:#{dhusPwd} #{url}"
