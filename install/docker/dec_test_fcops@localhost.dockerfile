...
COPY ./install/patch/patternformatter.rb /usr/local/bundle/gems/log4r-1.1.10/lib/log4r/outputter/
COPY ./install/patch/patternformatter.rb /usr/lib/ruby/gems/3.4.0/gems/log4r-1.1.10/lib/log4r/outputter/
# ------------------------------------------------
# ------------------------------------------------
#SHELL ["/bin/bash", "-c"]
USER dec
