...
alias decListDirUpload='podman exec -i -t dec decListDirUpload'
...
# tests
alias decTestInterface_NAOS_IVV-0500='podman exec -i -t dec decTestInterface_NAOS_IVV-0500'
alias decTestInterface_CelesTrak='podman exec -i -t dec decTestInterface_CelesTrak'
alias decTestInterface_NASA='podman exec -i -t dec decTestInterface_NASA'
