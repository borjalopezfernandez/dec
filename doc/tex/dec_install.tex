...
\section{Install OS Dependencies}
 ...
 \inlinecode{bash}{ \$> apt-get install ssh-askpass}  \newline
 ...
 \inlinecode{bash}{ \$> apt-get install zlib1g}  \newline
 \inlinecode{bash}{ \$> apt-get install zlib1g-dev}  \newline
 \inlinecode{bash}{ \$> apt-get install libbz2-dev}  \newline
 \inlinecode{bash}{ \$> apt-get install libreadline-dev}  \newline

\noindent 
In order to generate the documentation in pdf, please install the following package:
\inlinecode{bash}{ \$> apt-get install texlive-xetex}  \newline
...
\inlinecode{bash}{ \$> git clone https://github.com/asdf-vm/asdf.git ~/.asdf --branch v0.14.1}  \newline
...
\inlinecode{bash}{ \$> asdf install ruby 3.1.6} \newline

\par
\inlinecode{bash}{ \$> asdf local ruby 3.1.6\; asdf reshim ruby}\newline
...
\par
\inlinecode{bash}{ \$> gem install aux_latest.gem } \newline
\inlinecode{bash}{ \$> gem install dec_install_gemfile.gem } \newline
\par
