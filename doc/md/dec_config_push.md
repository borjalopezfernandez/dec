...
The general configuration file *dec_outgoing_files.xml* carries the items to drive push circulations from the defined interfaces.

[]{#decoutgoingfilesxml label="decoutgoingfilesxml"}

# Example dec_outgoing_files.xml {#LocalOutbox}
